...
$postet = $post->getPostUsername();

$table = 'posts';
$other = $post->getPostUsername();
    ...
    <div class="page-wrapper">
        ...
        <div class="content clearfix">
            <div class="main-content">
                <h1 class="recent-post-title" style="font-size: 32px; font-weight: bold;">Të Fundit</h1>
                ...
                <div class="post clearfix">
                    ...
                    <div class="post-preview" style="padding-left: 0px;padding-right: 35px;">
                        <h3 style="font-size: 20px; font-weight:bold;"><a href="single.php?id=<?php echo $post['id']; ?>"><?php echo substr($post['title'], 0, 110) . '...'; ?></a></h3>
                        <i class="fas fa-user">&nbsp;&nbsp;<span style="font-family: 'Manrope', sans-serif; font-weight: 500;"><?php echo $post['username']; ?></span></i>
                        &nbsp;
                        <?php $phpdate = strtotime($post['created_at']); ?>
                        <?php $mysqldate = date('Y F d', $phpdate ); ?>
                        <i class="fas fa-calendar">&nbsp;&nbsp;<span style="font-family: 'Manrope', sans-serif; font-weight: 500;"><?php echo $mysqldate; ?></span></i>
